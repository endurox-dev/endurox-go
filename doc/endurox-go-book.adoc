...
==== Executing Enduro/X after binaries built

When binaries are built and ready for running under the Enduro/X, ensure that
*LIBPATH* unset (or does not contain /opt/freeware/lib). As Enduro/X links against
stock AIX libraries, and these freeware libs are causing some conflicts.
